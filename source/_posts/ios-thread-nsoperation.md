...
# NSOperationQueue
![](https://github.com/qiudengqiang/blog-images/blob/master/nsopration_add_to_queue.png)
## 使用
...
```
## 最大并发数
![](https://github.com/qiudengqiang/blog-images/blob/masternsopration_queue_maxium.png)
...
# NSOperation和GCD的区别
![](https://github.com/qiudengqiang/blog-images/blob/master/gcd_and_nop_relationship.png)
## GCD
