...
![explain-sql](/assets/img/tech/image-20210401173711705.png)
...
![explain-sql2](/assets/img/tech/image-20210402080934143.png)
...
- 联合索引
  ...
  - ![distinct](/assets/img/tech/image-20210401174931790.png)
  - 区分度就是某个字段 column 不同值的个数除以表的总行数，比如性别的区分度就很小，不适合建立索引或不适合排在联合索引列的靠前的位置，而 uuid 这类字段就比较适合做索引或排在联合索引列的靠前的位置。



### 小结
![summary](/assets/img/tech/image-20210401175722407.png)
