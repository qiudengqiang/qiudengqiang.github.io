...
### 三次握手的描述
- 图解：![](/assets/img/tech/network_three_time_hand.png)
...
## TCP/IP网络参考模型
### 网络模型（理论）
![](/assets/img/tech/network_theory_model.png)
### 网络参考模型（现实）
![](/assets/img/tech/network_real_model.png)
### 通信过程
![](/assets/img/tech/network_commute_progress.png)
- 应用层 : APP
- 传输层 : TCP,确定数据如何传输
- 网络层 : 确定目标计算机的IP地址
- 链路层 : 硬件,添加帧头帧尾
...
![](/assets/img/tech/network_http_and_https_diff.png)

## HTTPS加密原理
![](/assets/img/tech/network_encode_principle.png)
