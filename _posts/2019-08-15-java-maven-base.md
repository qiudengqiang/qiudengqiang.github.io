...
![spring core](/assets/img/tech/maven-spring-core.png)

## 依赖管理
### scope 依赖范围
![spring core](/assets/img/tech/maven-dependency-scope.png)
...
![transport dependency](/assets/img/tech/maven-transport-dependency.png)
...
![optional dependency](/assets/img/tech/maven-optional-dependency.png)

### 排除依赖
exclusions可用于排除依赖,注意exclusions是写在dependency中
![optional dependency](/assets/img/tech/maven-exclusions-dependency.png)
...
![maven-tomcat-run](/assets/img/tech/maven-tomcat-run.png)
根据上边的提示信息，通过浏览器访问:http://localhost:8080/maven-helloworld/

## Maven 的概念模型
![maven-tomcat-run](/assets/img/tech/maven-concept-model.png)
...
![maven-project-life-cycle](/assets/img/tech/maven-project-lifecycle.png)
...
## IDEA 的 Maven 配置
![maven-idea-setting](/assets/img/tech/maven-idea-setting.png)

## IDEA 中创建一个 Maven 的 web 工程
打开 idea，选择创建一个新工程，选择 idea 提供好的 maven 的 web 工程模板
![maven-idea-project](/assets/img/tech/maven-idea-create-web-project.png)
点击 Next 填写项目信息
![maven-idea-project-gav](/assets/img/tech/maven-idea-create-project-gav.png)
点击 Next，此处不做改动。
![maven-idea-mul](/assets/img/tech/maven-idea-project-mul.png)
点击 Next 选择项目所在目录
![maven-idea-pp](/assets/img/tech/maven-idea-create-pp.png)
点击 Finish 后开始创建工程，耐心等待，直到出现如下界面。
![maven-idea-project-catalogue](/assets/img/tech/maven-idea-project-catalogue.png)
手动添加 src/main/java 目录，如下图右键 main 文件夹-New-Directory,创建一个新的文件夹命名为 java
![maven-idea-project-adddir](/assets/img/tech/maven-idea-project-adddir.png)
点击 OK 后，在新的文件夹 java 上右键 Make Directory as Sources Root
![maven-idea-project-source-root](/assets/img/tech/maven-idea-make-as-source-root.png)

### 创建一个 Servlet
src/java/main 创建了一个 Servlet，但报错
![maven-idea-project-servlet-error](/assets/img/tech/maven-idea-servlet-error.png)
要解决问题，就是要将 servlet-api-xxx.jar 包放进来，作为 maven 工程应当添加 servlet 的坐标，从而 导入它的 jar

### 在 pom.xml 文件添加坐标
直接打开 hello_maven 工程的 pom.xml 文件，再添加坐标
![maven-idea-pom-add-gav](/assets/img/tech/maven-idea-pom-add-gav.png)
...
![maven-dependency-scope](/assets/img/tech/maven-depedency-scope02.png)
...
## 添加 tomcat7 插件
在 pom 文件中添加如下内容
![maven-pom-tomcat7](/assets/img/tech/maven-pom-tomcat7.png)
此时点击 idea 最右侧 Maven Projects， 就可以看到我们新添加的 tomcat7 插件
双击 tomcat7 插件下 tomcat7:run 命令直接运行项目
![maven-pom-tomcat7](/assets/img/tech/maven-idea-tomcat7-run.png)
也可以直接点击如图按钮，手动输入 tomc7:run 命令运行项目
![maven-pom-tomcat7](/assets/img/tech/maven-idea-type-tomcat7-run.png)
点击后弹出如下图窗口
![maven-pom-tomcat7](/assets/img/tech/maven-idea-tomcat7-run02.png)

# Maven 工程运行调试

## 端口占用处理
重新执行 tomcat:run 命令重启工程，重启之前需手动停止 tomcat，否则报下边的错误:
![maven-pom-tomcat7](/assets/img/tech/maven-port-conflict.png)

## 断点调试
点击如图所示选项
![maven-idea-debug-edit](/assets/img/tech/maven-idea-debug-edit.png)
在弹出框中点击如图加号按钮找到 maven 选项
![maven-idea-debug-option](/assets/img/tech/maven-idea-debug-option.png)
在弹出窗口中填写如下信息
![maven-idea-debug-edit-fill](/assets/img/tech/maven-idea-debug-edit-fill.png)
完成后先 Apply 再 OK 结束配置后，可以在主界面找到我们刚才配置的操作名称。
![maven-idea-debug-window-btn](/assets/img/tech/maven-idea-debug-window-btn.png)
