...
![vs-view-preview](/assets/img/tech/vs-view-preview.png)

## 命令行的使用
如果你是在 macOS 上使用，安装后打开命令面板，搜索`shell` 命令：在 PATH 中安装 `code` 命令并执行，然后重启终端模拟就可以了。
![vs-shell-on-terminal](/assets/img/tech/vs-shell-on-terminal.png)
...
![vs-keyboard-shortcuts](/assets/img/tech/vs-keyboard-shortcuts.png)
...
![](/assets/img/tech/vs-bar-drag-and-drop.gif)
...
![](/assets/img/tech/vs-method-hover-window.gif)

如果我把鼠标移动到 foo 上面时，按下 Cmd 键，则能够在悬停提示窗口里直接看到 foo的实现。
![](/assets/img/tech/vs-method-hover-window-detail.gif)
